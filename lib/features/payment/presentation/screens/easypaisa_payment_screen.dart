...
class EasypaisaPaymentScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EasypaisaPaymentScreen> createState() =>
      _EasypaisaPaymentScreenState();
}

class _EasypaisaPaymentScreenState
    extends ConsumerState<EasypaisaPaymentScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInstructionCard(
                    step: '1',
                    title: 'Send Money via EasyPaisa',
                    description: 'Open your EasyPaisa app and send money to:',
                  ),
